    ...
    <form id="form1" runat="server" style="font-family: 'Phetsarath OT'">
        ...
        <div id="wrapper">
            ...
            <div class="modal fade" runat="server" id="myModalDelete" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="H1">ຢືນຢັນການລຶບກຸ່ມ</h4>
                        </div>
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            <ContentTemplate>
                                <div class="modal-body">
                                    <p>
                                        ທ່ານຕ້ອງການລຶບກຸ່ມທີ່ທ່ານເລືອກແທ້ຫຼືບໍ່ ?
                                    </p>
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1>ກຸ່ມ <small>ຈັດການຂໍ້ມູນກຸ່ມ</small></h1>
                        <ol class="breadcrumb">
                            <li class="active"><i class="fa fa-home"></i> ກຸ່ມ</li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                   ...
                   <div class="jumbotron">
                       <div class="row">
                    <div class="col-md-12">
                        <div class="row" runat="server" id="rowID" visible="false">
                            <div class="col-md-2"></div>
                            <div class="col-md-2">
                                <div class="input-group">
                                <span class="input-group-addon" ><span class="fa fa-tag" ></span></span>
                                <input type="text" runat="server" id="txtBranchID" class="form-control" autocomplete="off" readonly="readonly"/>
                            </div>
                            </div>
                        </div>
                        <p></p>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                <span class="input-group-addon" ><span class="fa fa-home" ></span></span>
                                <input type="text" runat="server" id="txtBranchName" class="form-control" placeholder="ປ້ອນຊື່ກຸ່ມ" autocomplete="off"/>
                            </div>
                            </div>
                        </div>
                    </div>
                       ...
                       <div class="row">
                           <div class="col-md-12">
                               <div class="row">
                                   <div class="col-md-2"></div>
                                   <div class="col-md-8">
                                       <uc1:GridControl runat="server" ID="gridBranch" GirdPageSize="100000" />
                                   </div>
                               </div>
                           </div>
                       </div>
                   ...
                   <%-- <Triggers>
                        ...
                        <asp:PostBackTrigger ControlID="txtBranchID" />
                        <asp:PostBackTrigger ControlID="txtBranchName" />
                    </Triggers>--%>
                </asp:UpdatePanel>
            </div>
            <!-- /#page-wrapper -->

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="discountSale.aspx.vb" Inherits="discountSale" %>
    ...
    <form id="form1" runat="server" style="font-family: 'Phetsarath OT'">
        ...
        <div id="wrapper">
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">ເພີ່ມຂໍ້ມູນໂບນັດ</h4>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <input type="text" runat="server" id="txtCreditPercent" class="form-control" placeholder="ເປີເຊັນໂບນັດ" maxlength="4"  autocomplete="off"/>
                            </div>
                            </div>
                            </div>
                            <p></p>
                    ...
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="dropdown active" runat="server" id ="cbManage">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li runat="server" id="menuDiscountSale" class="active"><a href="discountSale.aspx"><i class="fa fa-ellipsis-h"></i> ຈັດການໂບນັດ ( Bonus )</a></li>
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1>ໂບນັດໃນການຂາຍ <small>ຈັດການຂໍ້ມູນໂບນັດ</small></h1>
                        <ol class="breadcrumb">
                            <li class="active"><i class="fa fa-ellipsis-h"></i> ໂບນັດໃນການຂາຍ</li>
                        </ol>
                                ...
                                <div class="col-md-4">
                                    <div class="btn-group">
                                        <button runat="server" id="btnAddDiscount" type="button" class="btn btn-success">
                                            <span class="fa fa-plus"></span> ເພີ່ມຂໍ້ມູນໂບນັດ
                                        </button>
                                    </div>
                                </div>
                            </div>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="invoice.aspx.vb" Inherits="report" %>
    ...
    <form id="form1" runat="server" style="font-family: 'Phetsarath OT'">
        ...
        <div id="wrapper">
                    ...
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="dropdown active" runat="server" id="cbReport">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li runat="server" id="menuInvoice" class="active"><a href="invoice.aspx"><i class="fa fa-dollar"></i> ສະຫຼຸບຍອດເງິນທີ່ໄດ້ຮັບ</a></li>
                            </ul>
                        </li>
                    </ul>
            ...
            <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1>ສະຫຼຸບຍອດເງິນ <small>ສະແດງຂໍ້ມູນຍອດເງິນທີ່ໄດ້ຮັບ</small></h1>
                        <ol class="breadcrumb">
                            <li class="active"><i class="fa fa-dollar"></i> ສະຫຼຸບຍອດເງິນທີ່ໄດ້ຮັບ</li>
                        </ol>
              ...
              Welcome to SB Admin by <a class="alert-link" href="http://startbootstrap.com">Start Bootstrap</a>! Feel free to use this template for your admin needs! We are using a few different plugins to handle the dynamic tables and charts, so make sure you check out the necessary documentation links provided.
                ...
                <div class="row">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                            <ContentTemplate>
                                <h3><i class="fa fa-calendar"></i>
                                    <small>( ສະຫຼຸບຍອດເງິນທີ່ໄດ້ຮັບ ຕາມຊ່ວງວັນທີ
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                    <div class="row" runat="server" id="rowSum">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <uc1:Lo_GridControl runat="server" ID="gridReceiveTotal2" GirdPageSize="1000" />

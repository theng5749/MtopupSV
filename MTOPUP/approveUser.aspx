<%@ Page Language="VB" AutoEventWireup="false" CodeFile="approveUser.aspx.vb" Inherits="approveUser" %>
...
<body>
    <form id="form1" runat="server" style="font-family: 'Phetsarath OT'">
        ...
        <div id="wrapper">
            ...
            <div class="page-wrapper" style="padding:15px 25px;">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>ຈັດການຂໍ້ມູນຜູ້ອະນຸມັດ</h1>
                        <ol class="breadcrumb">
                ...
                <%-- alert success add --%>
                <div id="alertsuccessadd" runat="server" class="alert alert-success" >
                    <button runat="server" id="btnAlertImage1" type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <asp:Label runat="server" ID="Alertsucess" Text="ທຳການເພິ່ມຜູ້ອະນຸມັດສຳເລັດ"></asp:Label>
                </div>
                <%-- alert fail add --%>
                <div id="alertfailadd" runat="server" class="alert alert-danger" >
                    <button runat="server" id="btnAlertImage2" type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <asp:Label runat="server" ID="Alertfail" Text="ທຳການເພິ່ມຜູ້ອະນຸມັດບໍ່ສຳເລັດສຳເລັດ"></asp:Label>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" runat="server" id="txtNameApprove" maxlength="30" class="form-control" placeholder="ປ້ອນຊື່" autocomplete="off"/>
                            </div>
                            </div>
                             <div class="col-md-4">
                                 <div class="input-group">
                                     <span class="input-group-addon" ><span class="fa fa-phone" ></span></span>
                                     <input type="text" runat="server" id="txtteleApprove" maxlength="10" class="form-control" placeholder="ເບີໂທ" autocomplete="off" />
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <asp:DropDownList ID="ddDepartment" runat="server" CssClass="form-control" AutoPostBack="true">
                                        <asp:ListItem Value="0" Text="IT" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="FINANCE"></asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="btn-group btn-group-justified">
                                            ...
                                            <div class="btn-group">
                                                <button runat="server" id="btnDelete" type="button" class="btn btn-danger">
                                                    <span class="fa fa-times"></span> ລົບຜູ້ອະນຸມັດ ທີ່ຖືກເລືອກ ( 
                        ...
                        <div class="jumbotron">
                            <div class="row">
                                <div class="col-md-12">
                                    <uc1:GridControl runat="server" ID="gridUserApprove" />
                                </div>
                            </div>
                        </div>
                            </ContentTemplate>
